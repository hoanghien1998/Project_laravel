...
## API Documentation
https://apidocs.saritasa.io/?url=vinhvo/develop/vinhvo-latest.yaml

## Goolge Drive
TODO: setup link

## SonarQube
https://sonarqube.saritasa.com/dashboard?id=vinhvo-backend
...
```
mkdir vinhvo && cd vinhvo
git clone ssh://gitblit.saritasa.com/vinhvo/backend.git
cd backend
...
docker ps
```
There should be: vinhvo-web, vinhvo-db, vinhvo-redis
...
(*shortcut for ```docker inspect vinhvo-web | grep IPAddress```*) -
...
* Start *cron* inside Docker container, that runs [Laravel's schedule command](https://laravel.com/docs/5.6/scheduling) every minute
